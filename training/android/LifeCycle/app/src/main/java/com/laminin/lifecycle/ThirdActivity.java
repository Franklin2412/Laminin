...
public class ThirdActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_go_to_fourth_activity).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button_go_to_fourth_activity:
//                startActivityForResult(new Intent(this, FourthActivity.class), 100);
