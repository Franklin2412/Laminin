...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_go_to_first_activity).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        Log.d(TAG, ""+v.getId());
        switch (v.getId()){
            case R.id.button_go_to_first_activity:
                startActivityForResult(new Intent(this, FirstActivity.class), 100);
                break;
