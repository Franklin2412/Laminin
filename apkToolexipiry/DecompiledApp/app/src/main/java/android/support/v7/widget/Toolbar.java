    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ViewGroup.LayoutParams generateDefaultLayoutParams = Toolbar.this.generateDefaultLayoutParams();
        ...
        if (shouldLayout || shouldLayout2) {
            ...
            switch (this.mGravity & 112) {
                ...
                case com.payu.testapp.R.styleable.AppCompatTheme_panelMenuListTheme /*80*/:
                    ...
                    break;
                default:
                    i9 = (((height - paddingTop) - paddingBottom) - measuredHeight) / 2;
                    if (i9 < layoutParams.topMargin + this.mTitleMarginTop) {
                        i8 = layoutParams.topMargin + this.mTitleMarginTop;
                    } else {
                        measuredHeight = (((height - paddingBottom) - measuredHeight) - i9) - paddingTop;
                        i8 = measuredHeight < layoutParams.bottomMargin + this.mTitleMarginBottom ? Math.max(0, i9 - ((layoutParams2.bottomMargin + this.mTitleMarginBottom) - measuredHeight)) : i9;
                    }
                    i5 = paddingTop + i8;
                    break;
            }
            if (obj != null) {
                ...
                if (shouldLayout) {
                    ...
                    measuredWidth = i6 - this.mTitleTextView.getMeasuredWidth();
                    i9 = this.mTitleTextView.getMeasuredHeight() + i5;
                    this.mTitleTextView.layout(measuredWidth, i5, i6, i9);
                    measuredWidth -= this.mTitleMarginEnd;
                    i5 = i9 + layoutParams.bottomMargin;
                } else {
                    measuredWidth = i6;
                }
                if (shouldLayout2) {
                    ...
                    this.mSubtitleTextView.layout(i6 - this.mSubtitleTextView.getMeasuredWidth(), i5, i6, this.mSubtitleTextView.getMeasuredHeight() + i5);
                    i5 = i6 - this.mTitleMarginEnd;
                ...
                if (shouldLayout) {
                    ...
                    i9 = this.mTitleTextView.getMeasuredHeight() + i5;
                    this.mTitleTextView.layout(i7, i5, measuredWidth, i9);
                    measuredWidth = this.mTitleMarginEnd + measuredWidth;
                    i5 = layoutParams.bottomMargin + i9;
                } else {
                    measuredWidth = i7;
                }
                if (shouldLayout2) {
                    layoutParams = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    i5 += layoutParams.topMargin;
                    i9 = this.mSubtitleTextView.getMeasuredWidth() + i7;
                    this.mSubtitleTextView.layout(i7, i5, i9, this.mSubtitleTextView.getMeasuredHeight() + i5);
                    i5 = this.mTitleMarginEnd + i9;
                    i8 = layoutParams.bottomMargin;
                    i8 = i5;
                } else {
                    i8 = i7;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i3 < i4) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType != 0) {
                ...
                i5 = Math.max(combineMeasuredStates, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
                contentInsetStart = ViewUtils.combineMeasuredStates(i6, ViewCompat.getMeasuredState(childAt));
            } else {
                i5 = combineMeasuredStates;
                contentInsetStart = i6;
            }
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i, max2 + i7, i2, max, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i5 = Math.max(i5, measureChildCollapseMargins(this.mSubtitleTextView, i, max2 + i7, i2, max + contentInsetStart, iArr));
        ...
        contentInsetStart = Math.max(combineMeasuredStates, contentInsetStart);
        i7 = getPaddingLeft();
        int paddingRight = getPaddingRight();
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        i7 = ViewCompat.resolveSizeAndState(Math.max((i5 + max2) + (i7 + paddingRight), getSuggestedMinimumWidth()), i, ViewCompat.MEASURED_STATE_MASK & i6);
        i5 = ViewCompat.resolveSizeAndState(Math.max((paddingTop + paddingBottom) + contentInsetStart, getSuggestedMinimumHeight()), i2, i6 << 16);
        if (shouldCollapse()) {
            i5 = 0;
        }
