...
class ActivityChooserModel extends DataSetObservable {
    ...
    private final class DefaultSorter implements ActivitySorter {
        ...
        public void sort(Intent intent, List<ActivityResolveInfo> list, List<HistoricalRecord> list2) {
            ...
            int i2 = size2 + ActivityChooserModel.INVALID_INDEX;
            while (i2 >= 0) {
                float f2;
    ...
    private void readHistoricalDataImpl() {
        ...
        r10 = this;
        r9 = 1;
        r0 = r10.mContext;	 Catch:{ FileNotFoundException -> 0x00d3 }
        r1 = r10.mHistoryFileName;	 Catch:{ FileNotFoundException -> 0x00d3 }
    ...
    L_0x0031:
        ...
        r4 = r10.mHistoryFileName;	 Catch:{ all -> 0x00c8 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x00c8 }
    ...
    L_0x0051:
        return;
    L_0x0052:
        r0 = r10.mHistoricalRecords;	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
    ...
    L_0x0068:
        ...
        if (r3 == r4) goto L_0x0057;
    L_0x006b:
        r3 = "historical-record";
        r4 = r2.getName();	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r3 = r3.equals(r4);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
    ...
    L_0x00a0:
        ...
        goto L_0x0051;
    L_0x00a2:
        r3 = new android.support.v7.widget.ActivityChooserModel$HistoricalRecord;	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r4 = 0;
        r5 = "activity";
        r4 = r2.getAttributeValue(r4, r5);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r5 = 0;
        r6 = "time";
        r5 = r2.getAttributeValue(r5, r6);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r6 = java.lang.Long.parseLong(r5);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r5 = 0;
        r8 = "weight";
        r5 = r2.getAttributeValue(r5, r8);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r5 = java.lang.Float.parseFloat(r5);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r3.<init>(r4, r6, r5);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        r0.add(r3);	 Catch:{ XmlPullParserException -> 0x0031, IOException -> 0x007f }
        goto L_0x0057;
    L_0x00c8:
        r0 = move-exception;
