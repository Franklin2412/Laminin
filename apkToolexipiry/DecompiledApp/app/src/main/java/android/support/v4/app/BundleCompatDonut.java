...
class BundleCompatDonut {
    ...
    public static android.os.IBinder getBinder(android.os.Bundle r7, String r8) {
        /*
        r1 = 0;
        r6 = 1;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void putBinder(android.os.Bundle r6, String r7, android.os.IBinder r8) {
        /*
        r5 = 1;
