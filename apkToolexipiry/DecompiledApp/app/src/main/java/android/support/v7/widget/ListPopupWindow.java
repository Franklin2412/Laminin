...
public class ListPopupWindow {
        ...
        private boolean onTouchForwarded(MotionEvent motionEvent) {
            ...
            if (popup != null && popup.isShowing()) {
                ...
                if (access$600 != null && access$600.isShown()) {
                    ...
                    boolean z = (actionMasked == ListPopupWindow.POSITION_PROMPT_BELOW || actionMasked == 3) ? ListPopupWindow.POSITION_PROMPT_ABOVE : true;
                    return (onForwardedEvent && z) ? true : ListPopupWindow.DEBUG;
                }
            }
    ...
    public ListPopupWindow(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mDropDownHorizontalOffset = obtainStyledAttributes.getDimensionPixelOffset(android.support.v7.appcompat.R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = obtainStyledAttributes.getDimensionPixelOffset(android.support.v7.appcompat.R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            if (view2 != null) {
                ...
                view2.measure(MeasureSpec.makeMeasureSpec(i, i2), POSITION_PROMPT_ABOVE);
        ...
        i2 = getMaxAvailableHeight(getAnchorView(), this.mDropDownVerticalOffset, z);
        ...
        i = this.mDropDownList.measureHeightOfChildrenCompat(makeMeasureSpec, POSITION_PROMPT_ABOVE, MATCH_PARENT, i2 - i3, MATCH_PARENT);
        if (i > 0) {
            i3 += i4;
        }
        return i + i3;
    ...
    public void show() {
        ...
        if (this.mPopup.isShowing()) {
            ...
            popupWindow.update(anchorView, i2, i3, width, i);
            return;
        }
