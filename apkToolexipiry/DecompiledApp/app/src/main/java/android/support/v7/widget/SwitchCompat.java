...
public class SwitchCompat extends CompoundButton {
    ...
    private void animateThumbToCheckedState(boolean z) {
        ...
        this.mPositionAnimator.setAnimationListener(new AnonymousClass1(z));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (layout != null) {
            ...
            canvas.translate((float) ((i5 / TOUCH_MODE_DRAGGING) - (layout.getWidth() / TOUCH_MODE_DRAGGING)), (float) ((((i + i3) + (i2 - i4)) / TOUCH_MODE_DRAGGING) - (layout.getHeight() / TOUCH_MODE_DRAGGING)));
            layout.draw(canvas);
        }
        canvas.restoreToCount(save);
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            i6 = ((this.mSwitchWidth + paddingLeft) - max) - i6;
            max = paddingLeft;
        } else {
            paddingLeft = (getWidth() - getPaddingRight()) - i6;
            max = i6 + (max + (paddingLeft - this.mSwitchWidth));
            i6 = paddingLeft;
        }
        switch (getGravity() & 112) {
            case com.payu.testapp.R.styleable.Toolbar_titleMarginBottom /*16*/:
                paddingLeft = (((getPaddingTop() + getHeight()) - getPaddingBottom()) / TOUCH_MODE_DRAGGING) - (this.mSwitchHeight / TOUCH_MODE_DRAGGING);
    ...
    public void onMeasure(int i, int i2) {
        ...
        intrinsicWidth = Math.max(this.mSwitchMinWidth, (intrinsicWidth + (this.mThumbWidth * TOUCH_MODE_DRAGGING)) + i4);
