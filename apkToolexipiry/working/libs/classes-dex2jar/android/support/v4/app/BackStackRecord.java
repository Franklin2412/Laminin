...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    private boolean configureTransitions(int i, TransitionState transitionState, boolean z, SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        ...
        ViewRetriever anonymousClass1 = new AnonymousClass1(fragment);
        ...
        if (mergeTransitions != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, obj, view, anonymousClass1, transitionState.nonExistentView, transitionState.enteringEpicenterView, transitionState.nameOverrides, arrayList3, map, arrayMap, arrayList);
