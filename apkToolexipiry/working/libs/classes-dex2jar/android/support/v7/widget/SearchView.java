...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private boolean hasVoiceSearch() {
        ...
        return (intent == null || getContext().getPackageManager().resolveActivity(intent, AccessibilityNodeInfoCompat.ACTION_CUT) == null) ? IS_AT_LEAST_FROYO : true;
    }
    ...
    public void onActionViewCollapsed() {
        setQuery(BuildConfig.VERSION_NAME, IS_AT_LEAST_FROYO);
        clearFocus();
        updateViewsVisibility(true);
